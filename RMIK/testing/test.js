...
{
    const data = {
        nik: "3206020508190001",
        nama: "NANDA AIZA RAMADANI",
        nomor_whatsapp: "82344731525",
        ...
        detail_domisili: "Citoe, RT 001, RW 000"
    };
    const data_wali = {
    ...
    const month_map = {
        ...
        5: ["Mei"], 6: ["Juni", "Jun"], 7: ["Juli", "Jul"],
        8: ["Agustus", "Agt", "Agst"], 9: ["September", "Sep"],
    ...
    const wait_result_modal = async () =>
    {
        ...
        await wait_for(() => false, 3000);
        const err_check = await handle_error_modal(400);
        if (err_check.found)
        {
